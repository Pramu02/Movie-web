 ...
 <header class="masthead">
 	<div class="container pt-5">
 		<div class="col-lg-12">
 			<div class="row">
 				<div class="col-md-4">
 					<img src="images/<?php echo $mov['cover_img'] ?>"  alt="" class="img-responsive">
 				</div>
 				<div class="col-md-8">
 					...
 					<div class="card bg-light mt-2">
 						<div class="card-body">
 							...
 							<form action="" id="save-reserve">
 								<input type="hidden" name="movie_id" value="<?php echo $mov['id'] ?>">
 								<div class="row">
...
<script>
	$('[name="ts_id"]').change(function(){
		$.ajax({
			url:'manage_reserve.php?id='+$(this).val()+'&mid=<?php echo $mov['id'] ?>',
