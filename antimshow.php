...
$mov = $conn->query("SELECT * FROM movies where title ='Antim'")->fetch_array();
...
<div class="container">
         <div class="row">
            ...
            <img class="img-responsive" src="images/<?php echo $mov['cover_img']  ?>" alt="Antim"><br><br>
            </div>
        <div class = "col-md-7 cpl-lg-9">
        <div class="show detail">
         <h1>Antim</h1>
         <h1>The Antim Movie</h1>
        <h4><b>Genre</b>:Action, Crime, Drama</h4>
        <h4><b>Run-Time</b>:2hrs 22min</h4>
        <h4><b>Director</b>: Mahesh Manjrekar</h4>
        <h4><b>Cast</b>: Salman Khan, Aayush Sharma, Mahima Makwana</h4>
        <h4><b>SYNOPSIS</b>:The cop played by Salman fights the land mafia in the film.</h4>
        </div>
        </div> 
    </div>
    <div class="row">
