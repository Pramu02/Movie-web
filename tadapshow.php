...
$mov = $conn->query("SELECT * FROM movies where title ='Tadap'")->fetch_array();
...
<div class="container"data-id=<?php echo("SELECT id FROM movies WHERE title='Tadap';") ?>>
         <div class="row">
            <div class="col-md-5 col-lg-3">
            <img class="img-responsive" src="images/<?php echo $mov['cover_img']  ?>" alt="Tadap"><br><br>
            </div>
        <div class = "col-md-7 cpl-lg-9">
        <div class="show detail">
        <h1>Tadap</h1>
            <h4><b>Genre</b>:Action, Drama, Romance</h4>
            <h4><b>Run-Time</b>: 2hrs 10min</h4>
            <h4><b>Director</b>: ilan Luthria</h4>
            <h4><b>Cast</b>: Tara Sutaria, Ahan Shetty, Saurabh Shukla, Kumud Mishra</h4>
            <h4><b>SYNOPSIS</b>:A remake of the 2018 South Indian film RX 100.</h4>
        </section>
        </div>
        </div> 
    </div>
